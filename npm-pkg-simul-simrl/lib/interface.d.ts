...
interface calculateCapitalIncomeInterface {
    incomeObtainedInPortugueseTerritoryByEntitiesBasedInPortugal: {
        ...
        withholdingTaxInPortugalYear1: number;
        grossIncomeYear2: number;
        withholdingTaxInPortugalYear2: number;
    };
    ...
    rateNetIncomeBasedInPortugal: number;
    rateNetIncomeNotBasedInPortugal: number;
}
...
export { calculateNetIncomeDependentsAndPensionsInterface, calculateNetIncomeIndependentWithOrganizedAccountingInterface, calculateNetIncomeIndependentWithoutOrganizedAccountingTotalInterface, calculateNetIncomeIndependentWithoutOrganizedAccountingInterface, calculateNetIncomePropertyIncomeInterface, calculateExemptIncomeOrIntellectualPropertyInterface, calculateIncomeEarnedAbroadForResidentsInterface, calculateCapitalIncomeInterface, calculateIncomeEarnedAbroadForNonResidentsInterface, calculateOtherIncomeInterface, calculateIsRegularOrIrregularInterface, calculateReceiptsAverageTotalInterface, };
